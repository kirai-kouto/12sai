...
# 画像読み込み
king_img = tkinter.PhotoImage(file = 'assets/img4/chap4-2-1.png')
monsterA_img = tkinter.PhotoImage(file = 'assets/img4/chap4-2-2.png')
monsterB_img = tkinter.PhotoImage(file = 'assets/img4/chap4-2-3.png')
