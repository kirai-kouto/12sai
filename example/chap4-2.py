...
# 画像読み込み
img1 = tkinter.PhotoImage(file = 'assets/img4/chap4-1-1.png')
img2 = tkinter.PhotoImage(file = 'assets/img4/chap4-1-2.png')
img3 = tkinter.PhotoImage(file = 'assets/img4/chap4-1-3.png')
